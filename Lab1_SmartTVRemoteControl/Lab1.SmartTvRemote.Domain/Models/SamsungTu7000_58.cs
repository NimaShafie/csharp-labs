...
public sealed class SamsungTu7000_58 : TelevisionBase
{
    public SamsungTu7000_58(Screen screen) : base(screen) { }
    public override string Brand => "Samsung";
    public override string Model => "UN58TU7000";
    public override int SizeInches => 58;
