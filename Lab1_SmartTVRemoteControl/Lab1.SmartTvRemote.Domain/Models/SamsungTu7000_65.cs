...
public sealed class SamsungTu7000_65 : TelevisionBase
{
    public SamsungTu7000_65(Screen screen) : base(screen) { }
    public override string Brand => "Samsung";
    public override string Model => "UN65TU7000";
    public override int SizeInches => 65;
